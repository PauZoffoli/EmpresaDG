      ...
      <div id="gallery">
        <figure>
          ...
          <ul class="nospace clear">
            <li class="one_quarter first"><a class="nlb" data-lightbox-gallery="gallery1" href="{{asset('images/demo/gallery/1.png') }}" title="Display Text 1"><img class="borderedbox" src="{{asset('images/demo/gallery/1.png') }}" alt=""></a></li>
            <li class="one_quarter"><a class="nlb" data-lightbox-gallery="gallery1" href="{{asset('images/demo/gallery/1.png') }}" title="Display Text 2"><img class="borderedbox" src="{{asset('images/demo/gallery/1.png') }}" alt=""></a></li>
